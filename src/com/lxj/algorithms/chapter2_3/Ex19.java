...
public class Ex19 {
    ...
    private static Comparable median(Comparable i, Comparable j, Comparable k, Comparable m, Comparable n){
        Comparable[] a = new Comparable[]{i, j, k, m, n};
        Arrays.sort(a);
        return a[2];
    }
